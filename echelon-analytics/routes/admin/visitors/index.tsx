...
export const handler = define.handlers({
  async GET(ctx) {
    ...
    if (returning === "returning") {
      conditions.push("is_returning = 1");
    } else if (returning === "new") {
      conditions.push("is_returning = 0");
    }
    if (bot === "suspect") {
    ...
    const sql = `SELECT *,
      (SELECT COUNT(*) FROM visitor_views v2 WHERE v2.visitor_id = visitor_views.visitor_id) AS view_count,
